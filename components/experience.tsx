      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="">
          <motion.div
            ...
            className="grid lg:grid-cols-2 gap-6 max-w-6xl mx-auto relative before:hidden lg:before:block before:absolute before:inset-0 before:ml-5 before:-translate-x-px lg:before:mx-auto lg:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-purple-500 before:to-transparent"
          >

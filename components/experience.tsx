...
const education = [
  ...
  {
    degree: "Higher National Diploma in Information and Communication Technology",
    institution: "Ho Technical University",
    location: "Ho, Ghana",
...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 bg-black/5 backdrop-blur-sm" ref={ref}>
      <div className="container px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-4">Experience & Education</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            <motion.div
              ...
              className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px lg:before:mx-auto lg:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-purple-500 before:to-transparent"
            >
